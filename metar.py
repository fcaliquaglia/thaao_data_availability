...
if __name__ == "__main__":
    url = (
            ...
            ts.instr_metadata['macmap_tide_gauge']['end_instr'].year) + '&month2=' + str(
            ts.instr_metadata['macmap_tide_gauge']['end_instr'].month) + '&day2=' + str(
            ts.instr_metadata['macmap_tide_gauge'][
