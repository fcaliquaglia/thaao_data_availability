...
instr_metadata = {'metar'               : {'institution': 'U.Alaska,Florence,StonyBrook/USSF',
                  ...
                  'vespa'               : {'institution': 'INGV',
                                           'start_instr': dt.datetime(2016, 7, 1),
                                           'end_instr'  : dt.datetime.today(),
                                           'start_seas' : dt.datetime(1900, 1, 1),
                                           'end_seas'   : dt.datetime(1900, 12, 31)},
                  'ceilometer'          : {'institution': 'ENEA',
                                           'start_instr': dt.datetime(2019, 11, 1),
                                           'end_instr'  : dt.datetime.today(),
                                           'start_seas' : dt.datetime(1900, 1, 1),
                                           'end_seas'   : dt.datetime(1900, 12, 31)},
                  'hatpro'              : {'institution': 'ENEA',
                                           'start_instr': dt.datetime(2017, 1, 1),
                                           'end_instr'  : dt.datetime(2024, 9, 30),
                                           'start_seas' : dt.datetime(1900, 1, 1),
                                           'end_seas'   : dt.datetime(1900, 12, 31)},
                  'dir_rad_trkr'        : {'institution': 'DMI+ENEA',
                                           'start_instr': dt.datetime(2002, 10, 1),
                                           'end_instr'  : dt.datetime.today(),
                  ...
                  'pm10'                : {'institution': 'U.Alaska,Florence,StonyBrook/USSF',
                                           ...
                                           'start_seas' : dt.datetime(1900, 1, 1),
                                           'end_seas'   : dt.datetime(1900, 12, 31)},
                  'ecapac_mrr'          : {'institution': 'ENEA',
                                           'start_instr': dt.datetime(2022, 9, 1),
                                           'end_instr'  : dt.datetime.today(),
                                           'start_seas' : dt.datetime(1900, 1, 1),
                                           'end_seas'   : dt.datetime(1900, 12, 31)},
                  'ecapac_aws_snow'     : {'institution': 'ENEA',
                                           'start_instr': dt.datetime(2022, 9, 1),
                                           'end_instr'  : dt.datetime.today(),
                                           'start_seas' : dt.datetime(1900, 1, 1),
                                           'end_seas'   : dt.datetime(1900, 12, 31)},
                  'ecapac_disdro_precip': {'institution': 'ENEA',
                                           'start_instr': dt.datetime(2022, 9, 1),
                                           'end_instr'  : dt.datetime.today(),
                                           'start_seas' : dt.datetime(1900, 1, 1),
                                           'end_seas'   : dt.datetime(1900, 12, 31)},
                  'rs_sondes'           : {'institution': 'DMI+INGV',
                                           'start_instr': dt.datetime(1973, 1, 1),
                                           'end_instr'  : dt.datetime.today(),
                                           'start_seas' : dt.datetime(1900, 1, 1),
                                           'end_seas'   : dt.datetime(1900, 12, 31)},
                  'o3_sondes'           : {'institution': 'DMI',
                                           'start_instr': dt.datetime(1991, 12, 1),
                                           'end_instr'  : dt.datetime(2016, 12, 31),
                                           'start_seas' : dt.datetime(1900, 1, 1),
                                           'end_seas'   : dt.datetime(1900, 12, 31)},
                  'aero_sondes'         : {'institution': 'DMI',
                                           'start_instr': dt.datetime(1992, 1, 1),
                                           'end_instr'  : dt.datetime(1998, 12, 31),
                                           'start_seas' : dt.datetime(1900, 1, 1),
                                           'end_seas'   : dt.datetime(1900, 12, 31)},
                  'rad_tb'              : {'institution': 'ENEA',
                                           'start_instr': dt.datetime(2017, 1, 1),
                                           'end_instr'  : dt.datetime.today(),
                                           'start_seas' : dt.datetime(1900, 1, 1),
                                           'end_seas'   : dt.datetime(1900, 12, 31)},
                  'skycam'              : {'institution': 'ENEA',
                                           ...
                                           'start_seas' : dt.datetime(1900, 1, 1),
                                           'end_seas'   : dt.datetime(1900, 12, 31)},
                  'gnss'                : {'institution': 'INGV',
                                           'start_instr': dt.datetime(2021, 5, 1),
                                           'end_instr'  : dt.datetime.today(),
                                           'start_seas' : dt.datetime(1900, 1, 1),
                                           'end_seas'   : dt.datetime(1900, 12, 31)},
                  'rad_uli'             : {'institution': 'ENEA',
                                           'start_instr': dt.datetime(2016, 7, 1),
                                           'end_instr'  : dt.datetime.today(),
                                           'start_seas' : dt.datetime(1900, 1, 1),
                                           'end_seas'   : dt.datetime(1900, 12, 31)},
                  'rad_usi'             : {'institution': 'ENEA',
                                           'start_instr': dt.datetime(2016, 7, 1),
                                           'end_instr'  : dt.datetime.today(),
                                           'start_seas' : dt.datetime(1900, 1, 1),
                                           'end_seas'   : dt.datetime(1900, 12, 31)},
                  'rad_dli'             : {'institution': 'ENEA',
                                           'start_instr': dt.datetime(2009, 1, 1),
                                           'end_instr'  : dt.datetime.today(),
                                           'start_seas' : dt.datetime(1900, 1, 1),
                                           'end_seas'   : dt.datetime(1900, 12, 31)},
                  'rad_dsi'             : {'institution': 'DMI+ENEA',
                                           'start_instr': dt.datetime(2003, 2, 1),
                                           'end_instr'  : dt.datetime.today(),
                                           'start_seas' : dt.datetime(1900, 1, 1),
                                           'end_seas'   : dt.datetime(1900, 12, 31)},
                  'wv_isotopes'         : {'institution': 'U.Alaska,Florence,StonyBrook/USSF',
                                           ...
                                           'start_seas' : dt.datetime(1900, 1, 1),
                                           'end_seas'   : dt.datetime(1900, 12, 31)},
                  'macmap_seismometer_1': {'institution': 'INGV',
                                           'start_instr': dt.datetime(2021, 8, 1),
                                           'end_instr'  : dt.datetime.today(),
                                           'start_seas' : dt.datetime(1900, 3, 1),
                                           'end_seas'   : dt.datetime(1900, 11, 30)},
                  'macmap_seismometer_2': {'institution': 'INGV',
                                           'start_instr': dt.datetime(2021, 8, 1),
                                           'end_instr'  : dt.datetime.today(),
                                           'start_seas' : dt.datetime(1900, 3, 1),
                                           'end_seas'   : dt.datetime(1900, 11, 30)},
                  'macmap_seismometer_3': {'institution': 'INGV',
                                           'start_instr': dt.datetime(2021, 8, 1),
                                           'end_instr'  : dt.datetime.today(),
                                           'start_seas' : dt.datetime(1900, 3, 1),
                                           'end_seas'   : dt.datetime(1900, 11, 30)},
                  'macmap_seismometer_4': {'institution': 'INGV',
                                           'start_instr': dt.datetime(2022, 9, 1),
                                           'end_instr'  : dt.datetime.today(),
                                           'start_seas' : dt.datetime(1900, 3, 1),
                                           'end_seas'   : dt.datetime(1900, 11, 30)},
                  'macmap_tide_gauge'   : {'institution': 'INGV',
                                           'start_instr': dt.datetime(2021, 8, 1),
                                           'end_instr'  : dt.datetime.today(),
                                           'start_seas' : dt.datetime(1900, 3, 1),
                                           'end_seas'   : dt.datetime(1900, 11, 30)},
                  'mms_trios'           : {'institution': 'INGV',
                                           'start_instr': dt.datetime(2021, 9, 1),
                                           'end_instr'  : dt.datetime.today(),
                                           'start_seas' : dt.datetime(1900, 3, 1),
                                           'end_seas'   : dt.datetime(1900, 10, 31)},
                  'ftir'                : {'institution': 'NCAR',
                                           'start_instr': dt.datetime(1999, 10, 1),
                                           'end_instr'  : dt.datetime.today(),
                                           'start_seas' : dt.datetime(1900, 3, 1),
                                           'end_seas'   : dt.datetime(1900, 10, 31)},
                  'aeronet'             : {'institution': 'NCAR',
                                           'start_instr': dt.datetime(2007, 3, 1),
                                           'end_instr'  : dt.datetime.today(),
                                           'start_seas' : dt.datetime(1900, 3, 1),
                                           'end_seas'   : dt.datetime(1900, 10, 31)},
                  ...
                  'lidar_temp'          : {'institution': 'U.Sap+ENEA',
                                           'start_instr': dt.datetime(1993, 11, 1),
                                           'end_instr'  : dt.datetime.today(),
                                           'start_seas' : dt.datetime(1900, 11, 1),
                                           'end_seas'   : dt.datetime(1900, 3, 31)},
                  'lidar_ae'            : {'institution': 'U.Sap+ENEA',
                                           'start_instr': dt.datetime(1991, 9, 1),
                                           'end_instr'  : dt.datetime(1996, 3, 31),
                                           'start_seas' : dt.datetime(1900, 9, 1),
                                           'end_seas'   : dt.datetime(1900, 3, 31)},
                  'uv-vis_spec'         : {'institution': 'DMI',
                                           'start_instr': dt.datetime(1991, 2, 1),
                  ...
                  'gbms'                : {'institution': 'U.Alaska,Florence,StonyBrook/USSF',
                                           ...
                                           'start_seas' : dt.datetime(1900, 1, 1),
                                           'end_seas'   : dt.datetime(1900, 12, 31)},
                  'rad_par_up'          : {'institution': 'ENEA',
                                           'start_instr': dt.datetime(2016, 7, 1),
                                           'end_instr'  : dt.datetime.today(),
                                           'start_seas' : dt.datetime(1900, 1, 1),
                                           'end_seas'   : dt.datetime(1900, 12, 31)},
                  'rad_par_down'        : {'institution': 'ENEA',
                                           'start_instr': dt.datetime(2016, 7, 1),
                                           'end_instr'  : dt.datetime.today(),
                                           'start_seas' : dt.datetime(1900, 1, 1),
                                           'end_seas'   : dt.datetime(1900, 12, 31)}}
