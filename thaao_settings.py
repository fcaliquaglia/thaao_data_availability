...
instr_na_list = {'metar': {'institution': 'U.Alaska,Florence,StonyBrook/USSF', 'start_instr': dt.datetime(1951, 10, 1),
                 ...
                 'ecapac_mrr': {'institution': 'ENEA', 'start_instr': dt.datetime(2022, 9, 1),
                                'end_instr'  : dt.datetime.today(), 'start_seas': dt.datetime(1900, 1, 1),
                                'end_seas'   : dt.datetime(1900, 12, 31)},
                 'ecapac_aws': {'institution': 'ENEA', 'start_instr': dt.datetime(2022, 9, 1),
                                'end_instr'  : dt.datetime.today(), 'start_seas': dt.datetime(1900, 1, 1),
                                'end_seas'   : dt.datetime(1900, 12, 31)},
                 'ecapac_snow_height': {'institution': 'ENEA', 'start_instr': dt.datetime(2022, 9, 1),
                                        'end_instr'  : dt.datetime.today(), 'start_seas': dt.datetime(1900, 10, 1),
                 ...
                 'macmap_seismo_1': {'institution': 'INGV', 'start_instr': dt.datetime(2021, 8, 1),
                                     'end_instr'  : dt.datetime.today(), 'start_seas': dt.datetime(1900, 3, 1),
                                     'end_seas'   : dt.datetime(1900, 11, 30)},
                 'macmap_seismo_2': {'institution': 'INGV', 'start_instr': dt.datetime(2021, 8, 1),
                                     'end_instr'  : dt.datetime.today(), 'start_seas': dt.datetime(1900, 3, 1),
                                     'end_seas'   : dt.datetime(1900, 11, 30)},
                 'macmap_seismo_3': {'institution': 'INGV', 'start_instr': dt.datetime(2021, 8, 1),
                                     'end_instr'  : dt.datetime.today(), 'start_seas': dt.datetime(1900, 3, 1),
                                     'end_seas'   : dt.datetime(1900, 11, 30)},
                 'macmap_seismo_4': {'institution': 'INGV', 'start_instr': dt.datetime(2022, 9, 1),
                                     'end_instr'  : dt.datetime.today(), 'start_seas': dt.datetime(1900, 3, 1),
                                     'end_seas'   : dt.datetime(1900, 11, 30)},
...
events_list = {15: {'date': dt.datetime(1903, 3, 30), 'label': 'Danish Literary \n Expedition'},
...
campaign_list = {1 : {'start': dt.datetime(1991, 1, 1), 'end': dt.datetime(1991, 1, 31)},
...
def var_(yr):
    return {'seasons': {'MAM': {'start': dt.datetime(yr, 3, 1), 'end': dt.datetime(yr, 5, 31)},
                        'JJA': {'start': dt.datetime(yr, 6, 1), 'end': dt.datetime(yr, 8, 31)},
                        'SON': {'start': dt.datetime(yr, 9, 1), 'end': dt.datetime(yr, 11, 30)},
                        'DJF': {'start': dt.datetime(yr, 12, 1), 'end': dt.datetime(yr + 1, 2, 28)}},
            'months': {'Jan': {'start': dt.datetime(yr, 1, 1), 'end': dt.datetime(yr, 1, 31)},
                       'Feb': {'start': dt.datetime(yr, 2, 1), 'end': dt.datetime(yr, 2, 28)},
                       'Mar': {'start': dt.datetime(yr, 3, 1), 'end': dt.datetime(yr, 3, 31)},
                       'Apr': {'start': dt.datetime(yr, 4, 1), 'end': dt.datetime(yr, 4, 30)},
                       'May': {'start': dt.datetime(yr, 5, 1), 'end': dt.datetime(yr, 5, 31)},
                       'Jun': {'start': dt.datetime(yr, 6, 1), 'end': dt.datetime(yr, 6, 30)},
                       'Jul': {'start': dt.datetime(yr, 7, 1), 'end': dt.datetime(yr, 7, 31)},
                       'Aug': {'start': dt.datetime(yr, 8, 1), 'end': dt.datetime(yr, 8, 31)},
                       'Sep': {'start': dt.datetime(yr, 9, 1), 'end': dt.datetime(yr, 9, 30)},
                       'Oct': {'start': dt.datetime(yr, 10, 1), 'end': dt.datetime(yr, 10, 31)},
